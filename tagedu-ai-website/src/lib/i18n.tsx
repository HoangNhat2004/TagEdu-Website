...
const translations: Record<Language, Translations> = {
  en: {
    ...
    // Challenge 9
    "c9.title": "Mission Orbit 01 / Ignite Thrusters",
    ...
    "c9.term.check": "> Checking Fuel levels... [85%]",
  ...
  vi: {
    ...
    // Challenge 9
    "c9.title": "Nhiệm vụ Quỹ đạo 01 / Khởi động lực đẩy",
    ...
    "c9.term.check": "> Đang kiểm tra mức nhiên liệu... [85%]",
